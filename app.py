...
def test(x):
    x = load_html()
    return f"""<iframe id="sdinfframe" style="width: 100%; height: 1200px" name="result" allow="midi; geolocation; microphone; camera; 
...
# toolbar_js = load_js("toolbar", global_frame="parent.document")
